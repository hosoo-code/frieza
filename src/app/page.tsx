  ...
  return (
    <div className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden">
      ...
      <main className="w-full max-w-6xl mx-auto px-6 pt-32 pb-20 relative z-10 flex flex-col items-center text-center">
        ...
        >
          Манай элит модераторын багт нэгдээрэй. Доорх 4 нийгэмлэгт бүгдэд нь <strong className="text-white">50,000₮</strong>-өөр модератор болох боломжтой.
        </motion.p>
        ...
        >
          ...
          <p className="text-white/50 mb-10 max-w-2xl">Группуудыг доор дангаар нь үнэтэй харуулав. Хэрэв <span className="text-gold font-medium">бүгдэд нь</span> нэг дор модератор болохыг хүсвэл нэгтгэн ердөө <strong className="text-white">50,000₮</strong> төлнө.</p>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <GroupCard name="Групп нэг" members="520K+" price="30,000₮" url="https://www.facebook.com/groups/2851763551800791/" delay={0.1} />
            <GroupCard name="Групп хоёр" members="256K+" price="15,000₮" url="https://www.facebook.com/groups/1077106120145924/" delay={0.2} />
            <GroupCard name="Групп гурав" members="196K+" price="10,000₮" url="https://www.facebook.com/groups/1895852938000211/" delay={0.3} />
            <GroupCard name="Групп дөрөв" members="26K+" price="5,000₮" url="https://www.facebook.com/groups/1381119093749485/" delay={0.4} />
          </div>
        </motion.div>
...
function GroupCard({ name, members, url, price, delay }: { name: string; members: string; url: string; price: string; delay: number }) {
  return (
    <motion.div
      initial={{ opacity: 0, y: 20 }}
    ...
    >
      ...
      <p className="text-gold font-bold text-2xl mb-1">{members} <span className="text-sm text-white/50 font-normal">гишүүн</span></p>
      <p className="text-white/50 text-sm mb-6">Дангаар: <span className="text-white font-medium">{price}</span></p>
